...
describe('Backend Application Integration Tests with Multiple Users', () => {
    ...
    wsClients.forEach((wsClient) => {
        ...
        // Construct the message as plain text with required format
        var subscribeMessage = `SUBSCRIBE\nid:sub-0\ndestination:/topic/game/${gameId}\n\n\0`;

        // Send the subscription message with the correct format
    ...
    test('Owner starts the game and users listen to events', (done) => {
        ...
        ownerWsClient.on('MESSAGE', (message) => {
